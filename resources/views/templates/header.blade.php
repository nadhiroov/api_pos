        ...
        <nav class="navbar navbar-expand-lg p-0">
            ...
            <div class="d-block d-lg-none py-4">
                <a href="../main/index.html" class="text-nowrap logo-img">
                    <img src="{{ asset('assets/images/logos/rahat-dark.svg') }}" class="dark-logo" alt="Logo-Dark" />
                    <img src="{{ asset('assets/images/logos/rahat-light.svg') }}" class="light-logo" alt="Logo-light" />
                </a>
            </div>
